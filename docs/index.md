...
-   **253 张节点执行卡**
    ...
    全部 35 章统一给出触发、条件、动作、边界、证据与来源；每个节点都有一段温柔讲解，并配套 87 组深度正文讲解。

-   **v1.5 冲刺手册**

    用固定证据规则生成 56 个候选节点、64 张公式卡、21 组条件表和 40 张反例。
...
8. 进入冲刺阶段时，使用[v1.5 冲刺速查手册](17-sprint-manual.md)做路线选择、条件检查和反例回验。
